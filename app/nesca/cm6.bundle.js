        ...
        return {
            ...
            token: function (stream, state) {
                ...
                if (state.directive == 'schema') {
                    if (state.we_on_newline) {
                        stream.match(/\s*/);
                        var match = stream.match(/(input|output)(?=\s*=)/);
                        if (match) {
                            state.unitList.push(match[1]);
                            state.we_on_newline = false;
                            return "tagName";
                        ...
                        for (var _r = 0, schemaRules_1 = schemaRules; _r < schemaRules_1.length; _r++) {
                            var rule = schemaRules_1[_r];
                            if (stream.match(rule.regex)) {
                                return rule.token;
                            }
                        }
                ...
                if (state.directive == 'list') {
                    for (var _s = 0, listRules_1 = listRules; _s < listRules_1.length; _s++) {
                        var rule = listRules_1[_s];
                        if (stream.match(rule.regex)) {
                            return rule.token;
                        }
                    }
                ...
                if (state.directive == 'graphemes') {
                    for (var _t = 0, graphemesRules_1 = graphemesRules; _t < graphemesRules_1.length; _t++) {
                        var rule = graphemesRules_1[_t];
                        if (stream.match(rule.regex)) {
                            return rule.token;
                        }
                    }
                ...
                if (state.directive == 'feature-field') {
                    ...
                    state.we_on_newline = false;
                    for (var _y = 0, featureFieldRules_2 = featureFieldRules; _y < featureFieldRules_2.length; _y++) {
                        var rule = featureFieldRules_2[_y];
                        if (stream.match(rule.regex)) {
                            return rule.token;
                        }
                    }
                ...
                if (state.directive == 'stage') {
                    ...
                    if (state.sub_directive === 'routine') {
                        for (var _z = 0, routineRules_1 = routineRules; _z < routineRules_1.length; _z++) {
                            var rule = routineRules_1[_z];
                            if (stream.match(rule.regex)) {
                                return rule.token;
                            }
                        }
                    ...
                    // CHANCE
                        ...
                        for (var _1 = 0, chanceRules_1 = chanceRules; _1 < chanceRules_1.length; _1++) {
                            var rule = chanceRules_1[_1];
                            if (stream.match(rule.regex)) {
                                return rule.token;
                            }
                        }
                    ...
                    // Inside Feature matrix
                        ...
                        for (var _2 = 0, _3 = state.featureList; _2 < _3.length; _2++) {
                            var featuro = _3[_2];
                            if (stream.match(featuro, false)) {
                                var start = stream.pos;
                                var end = start + featuro.length;
                        ...
                        state.we_on_newline = false;
                        // Generic tokens
                        for (var _4 = 0, transformRules_1 = transformRules; _4 < transformRules_1.length; _4++) {
                            var rule = transformRules_1[_4];
                            if (stream.match(rule.regex)) {
                                return rule.token;
                            }
                        }
                        ...
                        for (var _5 = 0, _6 = state.catList; _5 < _6.length; _5++) {
                            var cato = _6[_5];
                            if (stream.match(cato)) {
                                return "tagName";
                            }
