...
var Word_Bank = class {
  ...
  alphabet;
  invisible;
  constructor(logger, lettercase_mapper2, build_start, schema_input, schema_output, input_words, input_divider, output_mode, output_divider, sort_words, alphabet, invisible) {
    this.logger = logger;
    this.lettercase_mapper = lettercase_mapper2;
    ...
    word_default.fields = schema_output.fields;
    word_default.field_delimiters = schema_output.delimiters;
    if (input_words == "") {
    ...
    for (let i = 0; i < input_word_array.length; i++) {
      ...
      const word = new word_default(null, my_field_values);
  ...
  Number of words: ` + this.words.length + `
...
var argv = yargs(hideBin(process.argv)).usage("Usage: $0 <path> [options]").help("help").wrap(null).epilog("For full documentation, visit: https://neonnaut.neocities.org/nesca_docs").alias({ help: "?", version: "v" }).option("output_mode", {
  alias: "m",
